...
declare namespace tt {
  ...
  interface Services {
    ...
    * Use this service to generate the URL to retrive the image.
    *
    * This service has **specific terms and conditions of usage**. For more information about this service please
    * refer to the {@link https://developer.tomtom.com/search-api/search-api-documentation/points-of-interest-details|POI Details API documentation}.
    */
    poiPhotos: PoiPhotosServiceFactory;
    /**
     * Makes a poi details request using the TomTom {@link https://developer.tomtom.com/search-api/search-api-documentation/points-of-interest-details|POI Details API}.
     *
     ...
     * refer to the {@link https://developer.tomtom.com/search-api/search-api-documentation/points-of-interest-details|POI Details API documentation}.
     */
    poiDetails: PoiDetailsServiceFactory;
  ...
  >;
  type PoiDetailsServiceFactory = ServiceFactory<
    PoiDetailsOptions,
    PoiDetailsResponse
  >;
  type PoiPhotosServiceFactory = ServiceFactory<
    PoiPhotosOptions,
    PoiPhotosResponse
  >;
  ...
  type PoiDetailsResponse = {
     ...
     */
    result: PoiDetailsResult;
  };

  type PoiDetailsResult = {
    /**
  ...
  type PriceRange = {
    ...
    value: number;
    /**
     * Label which describes the price range, for example: "Cheap",
     * "Moderate", "Expensive", "Very Expensive". Values might
